...
// .wrangler/tmp/pages-6qIsUR/bundledWorker-0.29677863076949784.mjs
...
var V = /* @__PURE__ */ __name2((e, t, n) => (n = e != null ? ne(ie(e)) : {}, ce(t || !e || !e.__esModule ? H(n, "default", { value: e, enumerable: true }) : n, e)), "V");
var m;
var u = T(() => {
  m = { collectedLocales: [] };
});
...
function Te() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, n) => e.has(n) ? e.get(n) : Reflect.get(globalThis, n), "get"), set: /* @__PURE__ */ __name2((t, n, s) => Ee.has(n) ? Reflect.set(globalThis, n, s) : (e.set(n, s), true), "set") });
}
__name(Te, "Te");
__name2(Te, "Te");
...
// .wrangler/tmp/pages-6qIsUR/ix36i13h0wl.js
...
// .wrangler/tmp/bundle-lGJWQh/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-lGJWQh/middleware-loader.entry.ts
